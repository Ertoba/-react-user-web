	...
	return (
		...
		>
			<CardContent sx={{ textAlign: 'center', padding: "18px" }}>
				...
				>
					{translateDynamicText(testimonial.review)}
				</Typography>
				...
				<Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
					...
					<Box>
						...
						<Typography variant="body2" color="text.secondary">
							{translateDynamicText(testimonial.designation)}
						</Typography>
					</Box>
				</Box>
			</CardContent>
			...
			<Grid container spacing={4} alignItems="center">
				...
				<Grid item xs={12} md={4}>
					<Box sx={{ pr: { md: 3 }, textAlign: { xs: 'center', md: 'left' } }}>
						...
						>
							<DollarSignHighlighter text={translateDynamicText(testimonial_section?.testimonial_title)} theme={theme} />
						...
						>
							{translateDynamicText(testimonial_section?.testimonial_sub_title)}
						</Typography>
						<Button onClick={handleOrderNow} variant='contained' sx={{ mt: { xs: "10px", md: "1rem" } }}>
							{translateDynamicText(testimonial_section?.testimonial_button_title)}
						</Button>
					</Box>
				</Grid>
