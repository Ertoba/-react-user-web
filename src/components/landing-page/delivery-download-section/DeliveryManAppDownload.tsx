          ...
          >
            ...
            >
              <DollarSignHighlighter
                text={translateDynamicText(deliveryManApp?.download_dm_app_title)}
                theme={theme}
              />
            </Typography>
            <Typography
              ...
              dangerouslySetInnerHTML={{
                __html: translateDynamicText(deliveryManApp?.download_dm_app_sub_title),
              }}
            />
          ...
          >
            <Box>
              <Typography
                ...
                textAlign={{ xs: "center" }}
              >
                {translateDynamicText(deliveryManApp?.download_dm_app_button_title)}
              </Typography>
              <Typography
                ...
                textAlign={{ xs: "center" }}
              >
                {translateDynamicText(deliveryManApp?.download_dm_app_button_sub_title)}
              </Typography>
            </Box>
            <Box
              sx={{
