          ...
          >
            <Grid item xs={12} sm={12} md={6}>
              ...
              >
                <CustomStackFullWidth>
                  ...
                  >
                      <DollarSignHighlighter
                        theme={theme}
                      text={translateDynamicText(landingPageData?.company_title)}
                    />
                  </Typography>
                  <Typography
                    variant={isSmall ? "h6" : "h4"}
                  ...
                  >
                      <DollarSignHighlighter
                        theme={theme}
                      text={translateDynamicText(landingPageData?.company_sub_title)}
                    />
                  </Typography>
                </CustomStackFullWidth>
                <Typography
                ...
                >
                  {translateDynamicText(landingPageData?.company_description)}
                </Typography>
                {landingPageData?.company_button_name && (
                  ...
                  >
                    <CustomButton onClick={handleButtonClick}>
                      ...
                      >
                        {" "}
                        {translateDynamicText(landingPageData?.company_button_name)}
