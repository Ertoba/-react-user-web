...
const ImageTitleSection: React.FC<ImageTitleSectionProps> = ({
    ...
    const dynamicTitle = translateDynamicText(highlight_section?.highlight_title)
    const dynamicSubtitle = translateDynamicText(highlight_section?.highlight_sub_title)
    const dynamicButtonText = translateDynamicText(highlight_section?.highlight_button_title)
