...
const RiderAppDownload: React.FC<RiderAppDownloadProps> = ({ riderApp }) => {
  ...
  const sectionTitle = translateDynamicText(riderApp?.download_rider_app_title || riderApp?.download_dm_app_title);
  const sectionSubTitle =
    translateDynamicText(riderApp?.download_rider_app_sub_title || riderApp?.download_dm_app_sub_title);
  const downloadButtonTitle =
    translateDynamicText(riderApp?.download_rider_app_button_title || riderApp?.download_dm_app_button_title);
