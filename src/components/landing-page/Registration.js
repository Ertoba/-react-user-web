          ...
          <Grid item xs={12} md={8.6} sx={{ textAlign: { xs: "center", md: "left" } }}>
            <Typography variant="h4" fontSize={{ xs: "18px", md: "30px" }} sx={{ fontWeight: "600" }}>
              <DollarSignHighlighter
                text={translateDynamicText(seller_app_download_section?.download_seller_app_title)}
                theme={theme}
              />
            </Typography>
            <Typography my=".7rem" sx={{ maxWidth: "400px" }} >
              {translateDynamicText(seller_app_download_section?.download_seller_app_sub_title)}
            </Typography>
            <Link href={{ pathname: "/store-registration", query: { active: "active" } }} prefetch={false}>
              <Button variant="contained" sx={{ borderRadius: "10px", padding: "7px 16px",marginBottom:{xs:"1rem",sm:"0px"} }}>
                {translateDynamicText(seller_app_download_section?.download_seller_app_content_button_title || "Start Selling")}
          ...
          <Stack alignItems="center" >
            <Box>
              <Typography fontSize={{ xs: "20px", md: "30px" }} fontWeight="600" lineHeight="1.4" textAlign={{ xs: "center", md: "left" }}>
                {translateDynamicText(seller_app_download_section?.download_seller_app_links?.download_user_app_title)}
              </Typography>
              <Typography color={theme.palette.neutral[500]} fontSize="16px" textAlign={{ xs: "center", md: "left" }}>
                {translateDynamicText(seller_app_download_section?.download_seller_app_links?.download_user_app_sub_title)}
              </Typography>
            </Box>
