        ...
        <Box sx={{ py: 6 }}>
            <Box textAlign="center" mb={4}>
                <Typography
                    ...
                    mb={1}
                >
                    <DollarSignHighlighter text={translateDynamicText(popular_client_section?.popular_client_title || 'Our Clients')} theme={theme} />
                    { }
                </Typography>
                <Typography
                    variant="h6"
                    ...
                    fontWeight="400"
                >
                    {translateDynamicText(popular_client_section?.popular_client_sub_title || 'Trusted by leading brands for fast and reliable delivery services.')}
                </Typography>
            </Box>
